...
class CreateGame extends Component {
  ...
  render() {
    ...
    const storedRounds = this.props.storedRound
      ...
      <div>
        ...
        <CreateGameWrapper>
          <Nav>
            ...
            <Link onClick={() => this.props.history.push("/settings")}>
              Settings
            </Link>
          ...
          <TopContainer>
            ...
            <div>
              ...
              <ButtonWrapper>
                <Button onClick={e => this.saveGameHandler(e)}>
                  Save Game
                </Button>
              </ButtonWrapper>
            </div>
